  ...
  for (var i = 0, len = str.length; i < len; ++i) {
    ...
    if (str.slice(i, open.length + i) == open) {
      ...
      if (0 == js.trim().indexOf('include')) {
        ...
        var includeOptions = _.assign({}, options, { filename: path, _with: false, open: open, close: close, compileDebug: compileDebug });
        include = exports.parse(include, includeOptions);
